...
/**
 * Renders a TS identifier for a parameter name, quoting it if it isn't a valid identifier
 * (e.g. MediaWiki param names containing a dash or starting with a digit). Reserved words like
 * "default" don't need quoting here since interface property names may be any valid identifier.
