...
- [x] Carry-over: opt-in, script-gated end-to-end tests against a public wiki (`en.wikipedia.org`), run via `npm run test:e2e` (not part of `npm test`/root `turbo run test`); see `packages/api/e2e/`.
